...
const getYouTube = (url) => {
  ...
  const projects = [
    ...
    { id: 7, category: "long", ...getYouTube("https://www.youtube.com/watch?v=rUWxSEwctFU") },
     { id: 1532, category: "beforeAfter", ...getYouTube("https://youtube.com/shorts/tyXZJhLJwVs?si=9tM1zAlR9ydV0l2E") },
    { id: 1326, category: "beforeAfter", ...getYouTube("https://youtube.com/shorts/M_AcLT77A0E?si=VxwLX_yNKt-MF0gC") },
    { id: 1375, category: "beforeAfter", ...getYouTube("https://youtube.com/shorts/ZPflmSu5h3w?si=88QKnmpVH6SepGdx") },
    { id: 1323, category: "beforeAfter", ...getYouTube("https://youtube.com/shorts/wAjHtq-QFXk?si=_JSrc4axE1jSjE0T") },
    { id: 1394, category: "beforeAfter", ...getYouTube("https://youtube.com/shorts/xUfu9MIRJ2U?si=uZc5MFJkhvw7WcIO") },
    { id: 139023, category: "beforeAfter", ...getYouTube("https://youtube.com/shorts/o4FJyhSmP9o?si=vNgh1KyFy9odVSEe") },
    ...
    { id: 132477, category: "beforeAfter", ...getYouTube("https://youtube.com/shorts/rdkrU0pII-8?si=zBFgXpe1ejBiCDV9") },
    { id: 130098  , category: "beforeAfter", ...getYouTube("https://youtube.com/shorts/z5Z5aDV3awg?si=jdQj8OyYY4Tb4mjI") },
